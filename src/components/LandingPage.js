  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-col items-start justify-start pt-0 px-0 pb-[250px] box-border relative gap-[69px] max-w-full mq750:gap-[34px] mq750:pb-[200px] mq750:box-border mq450:gap-[17px]"> {/* Bottom padding remains the same */}
        ...
        <FrameComponent onCategoriesTextClick={onCategoriesTextClick} />
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 px-5 box-border max-w-full mt-[-90px] text-base font-dm-sans"> {/* Adjusted margin-top */}
        <SearchBox />
      </div>
    </section>
  );
