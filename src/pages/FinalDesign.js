...
const FinalDesign = () => {
  return (
    <div className="w-full h-[3463px] relative bg-white overflow-hidden flex flex-col items-end justify-start pt-0 px-0 pb-[513px] box-border gap-[74px] leading-[normal] tracking-[normal] mq750:gap-[37px] mq1050:h-auto mq450:gap-[18px]">
      <LandingPage />
      <EventListing />
      <EventCreation />
      <section className="w-[1418px] flex flex-row items-start justify-center pt-0 px-5 pb-[11px] box-border max-w-full shrink-0 text-left text-21xl text-darkorange-200 font-montserrat">
